...
public class KeyAffinityStringKeyGenerator implements KeyGenerator {
   ...
   public void init(String param, ClassLoader classLoader) {
      ...
      wrapper = Infinispan51Wrapper.getInstance();
   }
   ...
   private void newKeyAffinityService() {
      ...
      affinityService = KeyAffinityServiceFactory.newLocalKeyAffinityService(wrapper.getCacheManager().getCache(cache), generator, executor, keyBufferSize);
