...
/**
 * The implementation of InfinispanQueryWrapper according to the changes done in infinispan 6.0
 *
 * @author Anna Manukyan
 */
public class Infinispan60QueryWrapper extends InfinispanQueryWrapper {
