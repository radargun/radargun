...
public class JDG66EmbeddedQueryable extends Infinispan70EmbeddedQueryable {
   ...
   protected static class QueryBuilder80Impl extends QueryBuilderImpl {
      ...
      protected Expression selectExpressionToExpression(Query.SelectExpression selectExpression) {
      ...
      public Query.Builder orderBy(Query.SelectExpression selectExpression, Query.SortOrder order) {
         ...
         builder.orderBy(selectExpressionToExpression(selectExpression), order == Query.SortOrder.ASCENDING ?
