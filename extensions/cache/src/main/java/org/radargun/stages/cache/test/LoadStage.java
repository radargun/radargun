...
public class LoadStage extends org.radargun.stages.test.LoadStage {
   ...
   protected KeyGenerator keyGenerator = DefaultStageConfiguration.createDefaultKeyGenerator();

   @Property(doc = "Generator of values. Default is byte-array.",
      complexConverter = ValueGenerator.ComplexConverter.class)
   protected ValueGenerator valueGenerator = DefaultStageConfiguration.createDefaultValueGenerator();
   ...
   protected CacheSelector cacheSelector = DefaultStageConfiguration.createDefaultCacheSelector();
