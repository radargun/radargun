...
public class Base64Coder {
    ...
    */
   public static String encodeStringISO88591(final String s) throws UnsupportedEncodingException {
   ...
   /**
    * Encodes a byte array into Base 64 format and breaks the output into lines of 76 characters. This method is compatible
   ...
   /**
    * Decodes a byte array from Base64 format and ignores line separators, tabs and blanks. CR, LF, Tab and Space characters
