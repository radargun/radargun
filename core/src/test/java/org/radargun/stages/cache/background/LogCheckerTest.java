...
public class LogCheckerTest {
   ...
   private LogChecker createLogChecker(GeneralConfiguration gc, LegacyLogicConfiguration lc, LogLogicConfiguration llc, BasicOperations.Cache cache) throws NoSuchFieldException, IllegalAccessException {
      ...
      setClassProperty(LogChecker.class, logChecker, "failureManager", manager.getFailureManager());
      setClassProperty(LogChecker.class, logChecker, "basicCache", manager.getBasicCache());
      setClassProperty(LogChecker.class, logChecker, "stressorRecordPool", pool);
      setClassProperty(LogChecker.class, logChecker, "log", mock(Log.class));
      setClassProperty(LogChecker.class, logChecker, "keyGenerator", new TestUtils.SimpleStringKeyGenerator());
      setClassProperty(LogChecker.class, logChecker, "logLogicConfiguration", llc);
      return logChecker;
   }
}
