...
JVM_OPTS="-server -Xmx600M -Xms600M -Xmn500M -Xss128K -XX:CompileThreshold=10000 -XX:+AggressiveHeap -XX:ThreadStackSize=64K -XX:SurvivorRatio=8 -XX:TargetSurvivorRatio=90 -XX:MaxTenuringThreshold=31 -Xshare:off"
